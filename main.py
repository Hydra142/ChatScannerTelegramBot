...
@bot.message_handler(
    func=lambda m: m.text in ["Add to blacklist", "Delete blacklist word", "Show blacklist", "Show chats",
                              "Show messages history", "Delete all messages history", "Enable monitoring",
                              "Disable monitoring", "Action:Delete", "Action:Warning"] and is_private_chat(m.chat))
            ...
            if forbidden_words:
                ...
                if forbidden_message_action == "Delete":
                    ...
                    bot.send_message(chat_id,
                                     f"@{user_name} sent a message containing forbidden words: {matched_forbidden_words}")
                else:
